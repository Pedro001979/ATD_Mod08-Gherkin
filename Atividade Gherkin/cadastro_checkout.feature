...
Como cliente da EBAC-SHOP, eu quero me cadastrar para finalizar minha compra.[
  ...
  Cenário: cadastro com dados Válidos
    Quando eu preencho todos os campos obrigátorios com dados válidos.
  ...
  Cenário: Tentativa de cadastro com email invalido
    ...
    E eu preencho os demais campos obrigátorios
    E eu clico no botão "Finalizar compra"
  ...
  Cenário: Tentativa de cadastro com ccampos obrigatorios vazios
    ...
    E eu preencho os demais campos obrigatorios com dados validos
    E eu clico no botão "Finalizar compra"
